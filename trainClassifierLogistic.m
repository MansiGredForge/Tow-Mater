function [trainedClassifier, validationAccuracy] = trainClassifierLogistic(trainingData)
...
% Auto-generated by MATLAB on 04-Oct-2020 20:55:26
...
predictorNames = {'Age', 'Driving_License', 'Region_Code', 'Previously_Insured', 'Vehicle_Age', 'Vehicle_Damage', 'Annual_Premium', 'Policy_Sales_Channel', 'Vintage'};
...
includedPredictorNames = predictors.Properties.VariableNames([false true false true true true true true true]);
predictors = predictors(:,includedPredictorNames);
isCategoricalPredictor = isCategoricalPredictor([false true false true true true true true true]);
...
trainedClassifier.RequiredVariables = {'Age', 'Annual_Premium', 'Driving_License', 'Policy_Sales_Channel', 'Previously_Insured', 'Region_Code', 'Vehicle_Age', 'Vehicle_Damage', 'Vintage'};
...
for fold = 1:KFolds
    ...
    % Data transformation: Select subset of the features
    % This code selects the same subset of features as were used in the app.
    includedPredictorNames = trainingPredictors.Properties.VariableNames([false true false true true true true true true]);
    trainingPredictors = trainingPredictors(:,includedPredictorNames);
    foldIsCategoricalPredictor = foldIsCategoricalPredictor([false true false true true true true true true]);
